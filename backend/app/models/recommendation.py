...
class ComparableAsin(TimestampMixin, Base):
    ...
    catalog_observed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    price_observed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    offer_count_observed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    rank_observed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    fee_observed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    review_observed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
